# CHONY Experiment 15 - Django Settings
...
SECRET_KEY = 'django-insecure-chony-weather-app-2024-haswinchony-23ag1a0555'
...
WEATHER_API_KEY = 'your_openweathermap_api_key_here'  # Replace with actual API key
